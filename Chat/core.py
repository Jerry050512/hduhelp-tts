...
from Chat.model import DVAE, Embed, GPT, gen_logits, Tokenizer, Speaker
...
from Chat.utils import logger as utils_logger
...
class Chat:
    ...
    def _infer(
        ...
        if isinstance(params_infer_code, dict):
            params_infer_code =self.InferCodeParams(**params_infer_code)
